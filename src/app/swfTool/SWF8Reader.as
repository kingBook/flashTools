package app.swfTool
{
	...
	import app.swfTool.swf8.tags.FileAttributesTag;
	import app.swfTool.swf8.tags.DefineFont3Tag;
	...
	import app.swfTool.swf8.tags.DefineScalingGridTag;
	import app.swfTool.swf8.tags.DefineShape4Tag;
	import app.swfTool.swf8.tags.DefineFontAlignZonesTag;
	import app.swfTool.swf8.records.ZoneRecord;
	import app.swfTool.swf8.tags.CSMTextSettingsTag;
	import app.swfTool.swf8.records.ZoneDataRecord;
	import app.swfTool.swf.records.IShapeRecord;
	import app.swfTool.swf8.records.StyleChangeRecord4;
	import app.swfTool.swf.records.EndShapeRecord;
	import app.swfTool.swf8.records.LineStyle2ArrayRecord;
	import app.swfTool.swf8.records.LineStyle2Record;
