package app.swfTool.abc
{
	...
	import app.swfTool.abc.tokens.StringToken;
	import app.swfTool.abc.tokens.NamespaceToken;
	import app.swfTool.abc.tokens.MultinameToken;
	import app.swfTool.abc.tokens.multinames.MultinameQNameToken;
	import app.swfTool.abc.instructions.IInstruction;
	import app.swfTool.abc.instructions.Instruction_findpropstrict;
	import app.swfTool.abc.instructions.Instruction_callproperty;
	import app.swfTool.abc.instructions.Instruction_getproperty;
	import app.swfTool.abc.instructions.Instruction_pop;
