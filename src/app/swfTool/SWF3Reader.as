package app.swfTool
{
	...
	import app.swfTool.swf3.tags.DoActionTag;
	import app.swfTool.swf3.records.ActionRecord;
	import app.swfTool.swf3.tags.PlaceObject2Tag;
	import app.swfTool.swf3.tags.DefineShape3Tag;
	import app.swfTool.swf3.tags.DefineBitsJPEG3Tag;
	import app.swfTool.swf3.tags.DefineBitsLossless2Tag;
	import app.swfTool.swf3.records.AlphaColorMapDataRecord;
	import app.swfTool.swf.records.RGBARecord;
	import app.swfTool.swf3.records.ARGBRecord;
	import app.swfTool.swf3.records.AlphaBitmapDataRecord;
	import app.swfTool.swf3.records.ShapeWithStyleRecord3;
	import app.swfTool.swf.records.IShapeRecord;
	import app.swfTool.swf3.records.StyleChangeRecord3;
	import app.swfTool.swf.records.EndShapeRecord;
	import app.swfTool.swf3.tags.DefineButton2Tag;
	import app.swfTool.swf3.records.ButtonRecord2;
	import app.swfTool.swf.records.FilterListRecord;
	import app.swfTool.swf.records.FilterRecord;
	import app.swfTool.swf.records.DropShadowFilterRecord;
	import app.swfTool.swf3.tags.DefineSpriteTag;
	import app.swfTool.swf.tags.EndTag;
	import app.swfTool.swf3.tags.FrameLabelTag;
	import app.swfTool.swf3.records.CXFormWithAlphaRecord;
	import app.swfTool.swf.records.ClipActionsRecord;
	import app.swfTool.swf.records.ClipActionRecord;
	import app.swfTool.swf.records.ClipEventFlagsRecord;
	import app.swfTool.swf3.records.GradientRecord2;
